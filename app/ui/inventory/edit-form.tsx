'use client';
import {updateInventory } from '@/app/lib/actions';
...
export default function EditInvetoryForm({
  inventory  
}: {
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={inventory.activity}
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={inventory.status === 'pending'}
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="received"
                  defaultChecked={inventory.status === 'received'}
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                />
                <label
                  htmlFor="received"
